...
class EffNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        # lip = self.lip_color(x)
        # lip = lip.view(lip.size(0), lip.size(1))
        # eye = self.eye_color(x)
        # eye = eye.view(eye.size(0), eye.size(1))
        hair = self.hair(x)
        ...
        return [hair,hair_color,gender,earring,smile,frontal_face]
